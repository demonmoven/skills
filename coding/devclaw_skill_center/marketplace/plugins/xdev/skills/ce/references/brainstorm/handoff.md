...
```bash
CONTENT=$(cat docs/xdev/ce/brainstorms/YYYY-MM-DD-<topic>-requirements.md)
...
Requirements doc: docs/xdev/ce/brainstorms/YYYY-MM-DD-<topic>-requirements.md  # if one was created
