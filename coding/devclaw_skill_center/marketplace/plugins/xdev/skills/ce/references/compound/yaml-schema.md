...
`schema.yaml` in this directory is the canonical contract for `docs/xdev/ce/solutions/` frontmatter written by `ce:compound`.
...
- `build_error` -> `docs/xdev/ce/solutions/build-errors/`
- `test_failure` -> `docs/xdev/ce/solutions/test-failures/`
- `runtime_error` -> `docs/xdev/ce/solutions/runtime-errors/`
- `performance_issue` -> `docs/xdev/ce/solutions/performance-issues/`
- `database_issue` -> `docs/xdev/ce/solutions/database-issues/`
- `security_issue` -> `docs/xdev/ce/solutions/security-issues/`
- `ui_bug` -> `docs/xdev/ce/solutions/ui-bugs/`
- `integration_issue` -> `docs/xdev/ce/solutions/integration-issues/`
- `logic_error` -> `docs/xdev/ce/solutions/logic-errors/`
- `developer_experience` -> `docs/xdev/ce/solutions/developer-experience/`
- `workflow_issue` -> `docs/xdev/ce/solutions/workflow-issues/`
- `best_practice` -> `docs/xdev/ce/solutions/best-practices/`
- `documentation_gap` -> `docs/xdev/ce/solutions/documentation-gaps/`
