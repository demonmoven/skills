...
- [Known Pattern] `docs/xdev/ce/solutions/export-pagination.md` -- previous export pagination fix applies to this endpoint
...
- **Learnings & Past Solutions section** -- results from learnings-researcher, with links to docs/xdev/ce/solutions/ files
