...
1. Ensure `docs/xdev/ce/ideation/` exists
2. Choose the file path:
   - `docs/xdev/ce/ideation/YYYY-MM-DD-<topic>-ideation.md`
   - `docs/xdev/ce/ideation/YYYY-MM-DD-open-ideation.md` when no focus exists
