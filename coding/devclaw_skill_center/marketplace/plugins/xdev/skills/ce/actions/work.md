> 移植自 [EveryInc/compound-engineering-plugin/ce-work](https://github.com/EveryInc/compound-engineering-plugin) v2.66.1（MIT）
...
When all Phase 2 tasks are complete and execution transitions to quality check, read `<skill_dir>/references/work/shipping-workflow.md` for the full shipping workflow: quality checks, code review, final validation, PR creation, and notification.
