...
### 如何引入
```jsx import
import { Carousel } from '@coze-arch/coze-design';
```
...
import { Carousel, Typography, Space } from '@coze-arch/coze-design';
...
```jsx live=true dir="column"
import React from 'react';
import { Carousel, RadioGroup, Radio, Space, Typography } from '@coze-arch/coze-design';
...
```jsx live=true dir="column"
import React from 'react';
import { Carousel, Space, Typography } from '@coze-arch/coze-design';
