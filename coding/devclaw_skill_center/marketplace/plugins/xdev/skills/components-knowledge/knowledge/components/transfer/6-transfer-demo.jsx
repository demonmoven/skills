...
import { IconCozHandle, IconCozCross } from '@coze-arch/coze-design/icons';
...
const Demo = () => {
    ...
    const renderSelectedItem = item => {
        ...
        const DragHandle = sortableHandle(() => <IconCozHandle className={`semi-right-item-drag-handler`} />); 
        return (
            <div className="components-transfer-demo-selected-item" key={item.label}>
                ...
                <IconCozCross onClick={item.onRemove} />
            </div>
        );
    };
