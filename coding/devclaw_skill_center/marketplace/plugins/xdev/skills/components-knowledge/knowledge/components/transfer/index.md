...
```jsx live=true dir="column"
import React from 'react';
import { Transfer, Checkbox, Avatar, Highlight } from '@coze-arch/coze-design';
...
```jsx live=true dir="column"
import React from 'react';
import { Transfer, Checkbox, Avatar } from '@coze-arch/coze-design';
...
```jsx live=true dir="column"
import React from 'react';
import { Transfer, Input, Spin, Button } from '@coze-arch/coze-design';
...
import { Transfer, Button, Spin, Input } from '@coze-arch/coze-design';
