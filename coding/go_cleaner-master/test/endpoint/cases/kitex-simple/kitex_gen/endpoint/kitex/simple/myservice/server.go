...
func NewServer(handler simple.MyService, opts ...server.Option) server.Server {
...
func NewServerWithBytedConfig(handler simple.MyService, config *byted.ServerConfig, opts ...server.Option) server.Server {
	var options []server.Option
...
func RegisterService(svr server.Server, handler simple.MyService, opts ...server.RegisterOption) error {
