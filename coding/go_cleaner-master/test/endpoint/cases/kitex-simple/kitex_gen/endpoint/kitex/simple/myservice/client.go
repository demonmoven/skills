...
type Client interface {
	Hello(ctx context.Context, req *simple.MyReq, callOptions ...callopt.Option) (r string, err error)
	ToClean1(ctx context.Context, req *simple.ToCleanReq, callOptions ...callopt.Option) (r *simple.ToCleanResp, err error)
	ToClean2(ctx context.Context, req *simple.ToCleanReq, callOptions ...callopt.Option) (r *simple.ToCleanResp, err error)
}
...
func (p *kMyServiceClient) Hello(ctx context.Context, req *simple.MyReq, callOptions ...callopt.Option) (r string, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.Hello(ctx, req)
}

func (p *kMyServiceClient) ToClean1(ctx context.Context, req *simple.ToCleanReq, callOptions ...callopt.Option) (r *simple.ToCleanResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.ToClean1(ctx, req)
}

func (p *kMyServiceClient) ToClean2(ctx context.Context, req *simple.ToCleanReq, callOptions ...callopt.Option) (r *simple.ToCleanResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
