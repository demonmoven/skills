---
name: harness-local-twin
description: "分析字节内场 Go 服务的外部依赖，评估本地化可行性并给出改造建议。扫描 go.mod、import、配置引用和网络调用，按 L0-L5 分层，产出依赖清单、最小可启动子集和改造路线图。本技能只做分析和建议，不执行实际改造。当用户提到本地孪生、local twin、服务本地化、本地运行内场服务、本地调试部署时激活。"
license: Apache-2.0
metadata:
  author: guoshuai.030
  version: "1.5"
