---
name: harness-doc-init
description: "为任意代码仓库建立 Harness Engineering 风格的基线文档体系。核心产出是分层 AGENTS.md、ARCHITECTURE.md 和 docs/ 索引体系，附带 pre-commit hook 配置建议（仅建议，不自动安装）。当用户提到 harness doc init、初始化文档体系、建立基线文档、harness 基线、为仓库建立文档导航、文档体系初始化时激活。"
license: Apache-2.0
metadata:
  author: guoshuai.030
  version: "1.4"
